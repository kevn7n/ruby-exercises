...
class PirateTest < Minitest::Test
  ...
  def test_a_pirate_has_booty
    ...
    pirate = Pirate.new("The Dread Pirate Kev", "Swashbuckler")
    assert_equal 0, pirate.count_booty
  end
  ...
  def test_a_pirate_gets_100_booty_for_robbing_ships
    ...
    pirate = Pirate.new("Jack Sparrow", "Swarthy Rogue")
    pirate.rob_ship
    assert_equal 100, pirate.count_booty
    pirate.rob_ship
    assert_equal 200, pirate.count_booty
    pirate.rob_ship
    assert_equal 300, pirate.count_booty
  end
